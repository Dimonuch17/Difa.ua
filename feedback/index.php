...
$form['form-1'] = array(
	'fields' => array(
		'name' => array(
			...
			'messages' => array(
				'preg' => 'Поле [ %1$s ] можливо містить помилку',
				'minlength' => 'Мінімальна довжина поля [ %1$s ] менше допустимої - %2$s',
				'maxlength' => 'Максимальна довжина поля [ %1$s ] перевищує допустиму - %2$s',
			)
		),
		'tell' => array(
			'title' => 'Телефон',
...
$form['form-2'] = array(
	...
	'cfg' => array(
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => 'Повидомлення відправлено - OK',
		'fuck' => 'Повидомлення відправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
	)
